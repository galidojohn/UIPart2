...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Add the songs
        songsArray.addAll(resources.getStringArray(R.array.sadboi))
        songsArray.addAll(resources.getStringArray(R.array.otaku))
        songsArray.addAll(resources.getStringArray(R.array.hype))
